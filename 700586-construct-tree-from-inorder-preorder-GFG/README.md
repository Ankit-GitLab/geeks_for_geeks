# [Construct Tree from Inorder & Preorder](https://www.geeksforgeeks.org/problems/construct-tree-1/0)
## Medium
...
Output: [1, 4, 3, 5, N, N, N, 2]Explanation: The tree will look like
Constraints:1 ≤ number of nodes ≤ 1030 ≤ nodes -&gt; data ≤ 103Both the inorder and preorder arrays contain unique values.
